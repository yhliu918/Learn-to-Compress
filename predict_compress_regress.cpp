...
std::vector<std::string> weights = {"../reg_model/reg_model_piecewise.txt","../reg_model/reg_model_nonlinear.txt","../reg_model/reg_model_FOR.txt","../reg_model/reg_model_rle.txt"};
...
int main() {
  ...
  for(int i=0;i<blocks;i++){
    ...
    res = codec_fac[pick_method]->encodeArray8(data.data()+(i*block_size),block_size ,descriptor,i);
