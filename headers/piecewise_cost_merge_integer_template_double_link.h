...
#ifndef PIECEWISE_COST_INTEGER_MERGE_DOUBLE_TEMPLATE_LINK_H_
#define PIECEWISE_COST_INTEGER_MERGE_DOUBLE_TEMPLATE_LINK_H_
...
namespace Codecset {
    template <typename T>
    class Leco_cost_merge_double_link
    {
    public:
